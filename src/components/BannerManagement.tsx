        ...
        <div className="flex-1 bg-[#eef1f5] px-8 py-5 rounded-md flex flex-wrap items-center justify-start gap-x-12 gap-y-4 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <select 
              ...
              className="w-32 h-[36px] px-3 bg-white border border-gray-300 rounded text-[14px] text-[#191F28] outline-none focus:border-[#008d75]"
            >
          ...
          <div className="flex items-center gap-4">
            ...
            <input 
              ...
              className="w-80 h-[36px] px-3 bg-white border border-gray-300 rounded text-[14px] text-[#191F28] outline-none focus:border-[#008d75] placeholder-[#8B95A1]"
            />
          </div>
        </div>
